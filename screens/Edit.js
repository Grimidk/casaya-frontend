...
const EditPropertyScreen = ({ route, navigation }) => {
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <TextInput style={styles.input} placeholder="Latitud" keyboardType="numeric" value={String(property.latitud)} onChangeText={(text) => handleChange("latitud", text)} />
      <TextInput style={styles.input} placeholder="Longitud" keyboardType="numeric" value={String(property.longitud)} onChangeText={(text) => handleChange("longitud", text)} />
